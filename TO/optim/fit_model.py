...
from TO.utils import  plot_predictions_and_residuals,plot_loss_history,plot_density_and_velocity_fields
plt.rcParams['font.family'] = 'DejaVu Sans'
plt.rcParams['font.size'] = 15
plt.rcParams['figure.dpi'] = 150


checkpoints=[1,500,1000,20000,30000,40000,50000]
lambdaa = 0.1
...
def calculate_loss_multioutput(model_list, iteration, diff_method='Numerical', title="default"):
    """
...
def find_TO(
    ...
    for j in tqdm(range(num_iter + 1), desc='Epoch', position=0, leave=True):
        ...
        loss_pde1, loss_pde2, loss_pde3, loss_dp, vol_loss = calculate_loss_multioutput(
            model_list, j, diff_method=diff_method, title=title
        )
