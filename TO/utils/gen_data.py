...
def get_data_fluid(problem = 'rugby', N_col_domain = 10000, N_train = 25.0, ratio=1.0):
    ...
    if problem == 'pipebend':
        ...
        ro_corners = torch.ones_like(x_corners[:,0])
        ...
        N_train_r = torch.floor(torch.tensor(N_train/3))  # For the new domain
        ...
        num_samples_range2 = int(N_train_r - num_samples_range1)  # Ensure total is exactly 100
